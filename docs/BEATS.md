...
Rail rule: level 3's rail never slows for a card and steering stays live while one is up; level 4's travel meter pauses while a card is up, so nothing arrives under the text.
...
| 6.4 | The through-line counter stops, moves to center on a dark plate, grows large. Its label becomes the caption: "The number of neutrinos that have passed through you since the start of the game:" and the number. No separate card. | | peek | none | F-32 | tick, then chime |
